...
///    L_MENSAGEM15.Caption :='Iniciando Atualização das Vendas do dia';
...
begin
  ...
  begin
    ...
    begin
  //    Application.MessageBox('Não Existem Novos Produtos Cadastrados Para Importar.','Informação.',MB_OK);
      BitBtn2.Enabled := True;
    end;
  end;
...
begin
  if cdsEstoqueProdutoTP_MOV.AsString = 'S'  then // condição
...
procedure TfrmAtuEstoqueServidor.DBGrid4DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  if cdsEstoqueProdutoServidorTP_MOV.AsString = 'S'  then // condição
...
begin
  ...
  begin
   ...
   Abort;
    ...
    begin
      L_MENSAGEM15.Caption := 'Aguarde.... Concluíndo....';
    end;
