...
begin
  ...
  begin
    try
      ...
      Application.MessageBox( 'Não Foi Possivél fazer a Conexão Local com o Banco de Dados.' + #13 +
 ...
 { if Application.MessageBox('Deseja Fazer a Conexão com o Servidor Agora?','Confirmação?',MB_YESNO+MB_ICONQUESTION )= idyes then
  begin
  ...
  begin
    Application.MessageBox('Conexão com o Servidor Cancelada.','Atenção.',MB_OK+MB_ICONWARNING);
  end;}
