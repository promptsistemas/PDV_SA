object frmRelvendasVendedor: TfrmRelvendasVendedor
  Left = 27
  Top = 35
  ...
  object GroupBox1: TGroupBox
    ...
    object Label1: TLabel
      ...
      Width = 241
      Height = 13
      Caption = ' Selecione o Vendedor (Vazio para Todos)'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object GroupBox2: TGroupBox
    ...
    object Label3: TLabel
      ...
      Width = 151
      Height = 13
      Caption = 'Total Geral das Comiss'#245'es'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object l_geral_comissao: TLabel
      Left = 177
      Top = 51
      Width = 66
      Height = 16
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = 'Geral'
      object QR_GERAL: TQuickRep
        Left = 64
        Top = 16
        Width = 794
        Height = 1123
        BeforePrint = QR_GERALBeforePrint
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel1: TQRLabel
            ...
            AlignToBand = False
            Caption = 'RELAT'#211'RIO DE COMISS'#195'O DE VENDEDORES'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -16
        ...
        object QRGroup1: TQRGroup
          ...
          PreCaluculateBandHeight = False
          KeepOnOnePage = False
          Expression = 'cdsRelVendas.VENDEDOR'
          FooterBand = QRBand3
          Master = QR_GERAL
        ...
        object QRBand3: TQRBand
          ...
          object QRL_TOTAL_COMISSAO: TQRLabel
            Left = 656
            Top = 2
            Width = 26
            Height = 17
        ...
        object QRBand4: TQRBand
          ...
          object QRL_GERAL_VENDAS: TQRLabel
            Left = 246
            Top = 7
            Width = 26
            Height = 17
          ...
          object QRL_GERAL_COMISSOES: TQRLabel
            Left = 246
            Top = 34
            Width = 26
            Height = 17
    ...
    object TabSheet2: TTabSheet
      Caption = 'Vendedor'
      ImageIndex = 1
      object QR_VENDEDOR: TQuickRep
        Left = 40
        Top = 18
        Width = 794
        Height = 1123
        BeforePrint = QR_VENDEDORBeforePrint
        DataSet = cdsRelVendas
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        ...
        object QRBand6: TQRBand
          ...
          object QRL_PERIODO_VENDEDOR: TQRLabel
            Left = 232
            Top = 24
            Width = 74
            Height = 17
        ...
        object QRBand10: TQRBand
          ...
          object QRL_TOTAL_PAG_VEND: TQRLabel
            Left = 633
            Top = 3
            Width = 31
            Height = 17
  ...
  object qRelVendas: TSQLQuery
    ...
    SQL.Strings = (
      ...
      ' v.vl_comissao,'
      ' SUM(P.vl_liquido)*(v.vl_comissao)/100 AS COMISSAO'
      'FROM tb_pdv P'
    ...
    Left = 112
    Top = 136
    object qRelVendasDT_ORCAMENTO: TDateField
      FieldName = 'DT_ORCAMENTO'
    end
    object qRelVendasID_VENDEDOR: TIntegerField
      FieldName = 'ID_VENDEDOR'
    end
    object qRelVendasVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      ReadOnly = True
      Size = 30
    end
    object qRelVendasTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object qRelVendasCOMISSAO: TFMTBCDField
      FieldName = 'COMISSAO'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object qRelVendasVL_COMISSAO: TFMTBCDField
      FieldName = 'VL_COMISSAO'
      ReadOnly = True
      Precision = 18
      Size = 2
  ...
  object cdsRelVendas: TClientDataSet
    ...
    Left = 176
    Top = 136
    object cdsRelVendasDT_ORCAMENTO: TDateField
    ...
    object cdsRelVendasVENDEDOR: TStringField
      DisplayLabel = 'Vendedor'
      FieldName = 'VENDEDOR'
      ReadOnly = True
      Size = 30
    end
    object cdsRelVendasTOTAL: TFMTBCDField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      ReadOnly = True
      DisplayFormat = '###,###0.00'
    ...
    object cdsRelVendasVL_COMISSAO: TFMTBCDField
