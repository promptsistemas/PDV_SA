object DM: TDM
  ...
  object qPdvLocal: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'FROM'
      ' TB_PDV PDV'
      'LEFT JOIN TB_VENDEDOR V ON (V.ID_VENDEDOR = PDV.ID_VENDEDOR)'
      'LEFT JOIN TB_USUARIOS U ON (U.ID_USUARIO = PDV.ID_USUARIO)'
      'WHERE'
      ' PDV.STATUS = '#39'A'#39
      'AND PDV.CAIXA = :CAIXA')
    ...
    object qPdvLocalID_USUARIO: TIntegerField
      FieldName = 'ID_USUARIO'
    end
    object qPdvLocalLOGIN: TStringField
      FieldName = 'LOGIN'
      ProviderFlags = []
      Size = 10
    end
    object qPdvLocalHR_ORCAMENTO: TTimeField
      FieldName = 'HR_ORCAMENTO'
    end
    object qPdvLocalCUPOM: TStringField
      FieldName = 'CUPOM'
      Size = 1
    end
    object qPdvLocalPERC_DESC: TFMTBCDField
      FieldName = 'PERC_DESC'
      Precision = 18
      Size = 2
    end
    object qPdvLocalMODALIDADE: TIntegerField
      FieldName = 'MODALIDADE'
    end
    object qPdvLocalVL_TOTAL_AV: TFMTBCDField
      FieldName = 'VL_TOTAL_AV'
      Precision = 18
      Size = 2
    end
  end
  object dspPdvLocal: TDataSetProvider
    ...
    OnGetTableName = dspPdvLocalGetTableName
    Left = 80
    Top = 88
  end
  object cdsPdvLocal: TClientDataSet
    ...
    object cdsPdvLocalID_USUARIO: TIntegerField
      FieldName = 'ID_USUARIO'
    end
    object cdsPdvLocalLOGIN: TStringField
      DisplayLabel = 'Usu'#225'rio'
      FieldName = 'LOGIN'
      ProviderFlags = []
      Size = 10
    end
    object cdsPdvLocalHR_ORCAMENTO: TTimeField
      FieldName = 'HR_ORCAMENTO'
    end
    object cdsPdvLocalCUPOM: TStringField
      FieldName = 'CUPOM'
      Size = 1
    end
    object cdsPdvLocalPERC_DESC: TFMTBCDField
      FieldName = 'PERC_DESC'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsPdvLocalMODALIDADE: TIntegerField
      FieldName = 'MODALIDADE'
    end
    object cdsPdvLocalVL_TOTAL_AV: TFMTBCDField
      DisplayLabel = 'Vl. Total Av'
      FieldName = 'VL_TOTAL_AV'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
  ...
  object qItemPdvLocal: TSQLQuery
    ...
    object qItemPdvLocalNCM_PRODUTO: TStringField
      FieldName = 'NCM_PRODUTO'
      ProviderFlags = []
      Size = 15
    end
    object qItemPdvLocalCOD_PRODUTO: TIntegerField
      FieldName = 'COD_PRODUTO'
      ProviderFlags = []
    end
    object qItemPdvLocalVL_AVISTA: TFMTBCDField
      FieldName = 'VL_AVISTA'
      Precision = 18
      Size = 2
    end
    object qItemPdvLocalVL_TOTAL_AV: TFMTBCDField
      FieldName = 'VL_TOTAL_AV'
      Precision = 18
      Size = 2
    end
  ...
  object dspItemPdvLocal: TDataSetProvider
    ...
    Options = [poIncFieldProps, poAllowMultiRecordUpdates, poAutoRefresh, poAllowCommandText]
    OnGetTableName = dspItemPdvLocalGetTableName
    Left = 80
    Top = 136
  end
  object cdsItemPdvLocal: TClientDataSet
    ...
    object cdsItemPdvLocalNCM_PRODUTO: TStringField
      FieldName = 'NCM_PRODUTO'
      ProviderFlags = []
      Size = 15
    end
    object cdsItemPdvLocalCOD_PRODUTO: TIntegerField
      FieldName = 'COD_PRODUTO'
      ProviderFlags = []
    end
    object cdsItemPdvLocalVL_AVISTA: TFMTBCDField
      DisplayLabel = 'Vl.Avista'
      FieldName = 'VL_AVISTA'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsItemPdvLocalVL_TOTAL_AV: TFMTBCDField
      DisplayLabel = 'Vl. Total Av'
      FieldName = 'VL_TOTAL_AV'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
  ...
  object dsItemPdvLocal: TDataSource
    ...
    OnDataChange = dsItemPdvLocalDataChange
    Left = 144
    Top = 136
  end
  object cdsProduto: TClientDataSet
    ...
    object cdsProdutoVL_VENDA: TFMTBCDField
    ...
    object cdsProdutoVL_VENDA_PRAZO1: TFMTBCDField
      DisplayLabel = 'Vl 1 X '
    ...
    object cdsProdutoVL_VENDA_PRAZO2: TFMTBCDField
      DisplayLabel = 'Vl  2 X'
    ...
    object cdsProdutoVL_VENDA_PRAZO3: TFMTBCDField
      DisplayLabel = 'Vl 3 X'
  ...
  object qProduto: TSQLQuery
    ...
    object qProdutoVL_VENDA: TFMTBCDField
      FieldName = 'VL_VENDA'
      Precision = 18
      Size = 2
    end
    ...
    object qProdutoVL_VENDA_PRAZO1: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO1'
      Precision = 18
      Size = 2
    end
    object qProdutoVL_VENDA_PRAZO2: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO2'
      Precision = 18
      Size = 2
    end
    object qProdutoVL_VENDA_PRAZO3: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO3'
      Precision = 18
      Size = 2
    end
  ...
  object qRecebeProduto: TSQLQuery
    ...
    object qRecebeProdutoVL_VENDA_ATAC: TFMTBCDField
      FieldName = 'VL_VENDA_ATAC'
      Precision = 18
      Size = 2
    end
    object qRecebeProdutoVL_VENDA_PRAZO1: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO1'
      Precision = 18
      Size = 2
    end
    object qRecebeProdutoVL_VENDA_PRAZO2: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO2'
      Precision = 18
      Size = 2
    end
    object qRecebeProdutoVL_VENDA_PRAZO3: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO3'
      Precision = 18
      Size = 2
    end
  ...
  object cdsRecebeProduto: TClientDataSet
    ...
    object cdsRecebeProdutoVL_VENDA_ATAC: TFMTBCDField
      DisplayLabel = 'Vl Venda Atac'
      FieldName = 'VL_VENDA_ATAC'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
    ...
    object cdsRecebeProdutoVL_VENDA_PRAZO1: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo1'
      FieldName = 'VL_VENDA_PRAZO1'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsRecebeProdutoVL_VENDA_PRAZO2: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo 2'
      FieldName = 'VL_VENDA_PRAZO2'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsRecebeProdutoVL_VENDA_PRAZO3: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo 3'
      FieldName = 'VL_VENDA_PRAZO3'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
  ...
  object qEnviaProduto: TSQLQuery
    ...
    object qEnviaProdutoPDV: TStringField
      FieldName = 'PDV'
      FixedChar = True
      Size = 1
    end
    object qEnviaProdutoVL_VENDA_ATAC: TFMTBCDField
      FieldName = 'VL_VENDA_ATAC'
      Precision = 18
      Size = 2
    end
    object qEnviaProdutoVL_VENDA_PRAZO1: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO1'
      Precision = 18
      Size = 2
    end
    object qEnviaProdutoVL_VENDA_PRAZO2: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO2'
      Precision = 18
      Size = 2
    end
    object qEnviaProdutoVL_VENDA_PRAZO3: TFMTBCDField
      FieldName = 'VL_VENDA_PRAZO3'
      Precision = 18
      Size = 2
    end
  ...
  object cdsEnviaProduto: TClientDataSet
    ...
    object cdsEnviaProdutoPDV: TStringField
      FieldName = 'PDV'
      FixedChar = True
      Size = 1
    end
    object cdsEnviaProdutoVL_VENDA_ATAC: TFMTBCDField
      DisplayLabel = 'Vl Venda Atac'
      FieldName = 'VL_VENDA_ATAC'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
    ...
    object cdsEnviaProdutoVL_VENDA_PRAZO1: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo 1'
      FieldName = 'VL_VENDA_PRAZO1'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsEnviaProdutoVL_VENDA_PRAZO2: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo 2'
      FieldName = 'VL_VENDA_PRAZO2'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
    ...
    object cdsEnviaProdutoVL_VENDA_PRAZO3: TFMTBCDField
      DisplayLabel = 'Vl Venda Prazo 3'
      FieldName = 'VL_VENDA_PRAZO3'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
  ...
  object cdsLoja: TClientDataSet
    ...
    Left = 112
    Top = 280
    object cdsLojaID_LOJA: TIntegerField
      FieldName = 'ID_LOJA'
      Required = True
    end
    object cdsLojaCOD_MUNICIPIO: TStringField
      FieldName = 'COD_MUNICIPIO'
      Size = 7
    end
    object cdsLojaR_SOCIAL: TStringField
      FieldName = 'R_SOCIAL'
      Size = 50
    end
    object cdsLojaFANTASIA: TStringField
      FieldName = 'FANTASIA'
      Size = 40
    end
    object cdsLojaENDERECO: TStringField
      FieldName = 'ENDERECO'
      Size = 40
    end
    object cdsLojaCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 30
    end
    object cdsLojaNUMERO: TStringField
      FieldName = 'NUMERO'
      FixedChar = True
      Size = 18
    end
    object cdsLojaBAIRRO: TStringField
      FieldName = 'BAIRRO'
      Size = 35
    end
    object cdsLojaCNPJ: TStringField
      FieldName = 'CNPJ'
      Size = 18
    end
    object cdsLojaINS_EST: TStringField
      FieldName = 'INS_EST'
      Size = 14
    end
    object cdsLojaTEL: TStringField
      FieldName = 'TEL'
      Size = 14
    end
    object cdsLojaGERENTE: TStringField
      FieldName = 'GERENTE'
      Size = 35
    end
    object cdsLojaID_GRUPO_LOJA: TIntegerField
      FieldName = 'ID_GRUPO_LOJA'
    end
    object cdsLojaID_C_CUSTO: TIntegerField
      FieldName = 'ID_C_CUSTO'
    end
    object cdsLojaVL_DIARIO_PAGMETO: TFMTBCDField
      FieldName = 'VL_DIARIO_PAGMETO'
      Precision = 18
      Size = 2
    end
  end
  ...
  object qLoja: TSQLQuery
    ...
    Left = 50
    Top = 280
    object qLojaID_LOJA: TIntegerField
      FieldName = 'ID_LOJA'
      Required = True
    end
    object qLojaCOD_MUNICIPIO: TStringField
      FieldName = 'COD_MUNICIPIO'
      Size = 7
    end
    object qLojaR_SOCIAL: TStringField
      FieldName = 'R_SOCIAL'
      Size = 50
    end
    object qLojaFANTASIA: TStringField
      FieldName = 'FANTASIA'
      Size = 40
    end
    object qLojaENDERECO: TStringField
      FieldName = 'ENDERECO'
      Size = 40
    end
    object qLojaCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 30
    end
    object qLojaNUMERO: TStringField
      FieldName = 'NUMERO'
      FixedChar = True
      Size = 18
    end
    object qLojaBAIRRO: TStringField
      FieldName = 'BAIRRO'
      Size = 35
    end
    object qLojaCNPJ: TStringField
      FieldName = 'CNPJ'
      Size = 18
    end
    object qLojaINS_EST: TStringField
      FieldName = 'INS_EST'
      Size = 14
    end
    object qLojaTEL: TStringField
      FieldName = 'TEL'
      Size = 14
    end
    object qLojaGERENTE: TStringField
      FieldName = 'GERENTE'
      Size = 35
    end
    object qLojaID_GRUPO_LOJA: TIntegerField
      FieldName = 'ID_GRUPO_LOJA'
    end
    object qLojaID_C_CUSTO: TIntegerField
      FieldName = 'ID_C_CUSTO'
    end
    object qLojaVL_DIARIO_PAGMETO: TFMTBCDField
      FieldName = 'VL_DIARIO_PAGMETO'
      Precision = 18
      Size = 2
    end
  ...
  object spGravaEstoqueProdutoTroca: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    SQLConnection = ConexaoLocal
    StoredProcName = 'GRAVA_ESTOQUE_PRODUTO_TROCA'
    Left = 48
    Top = 448
  end
  object dspGravaEstoqueProdutoTroca: TDataSetProvider
    DataSet = spGravaEstoqueProdutoTroca
    Options = [poIncFieldProps, poAllowMultiRecordUpdates, poAutoRefresh, poAllowCommandText, poUseQuoteChar]
    Left = 80
    Top = 448
  end
  object cdsGravaEstoqueProdutoTroca: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'dspGravaEstoqueProdutoTroca'
    Left = 112
    Top = 448
  end
  object qPlanoPagamento: TSQLQuery
    ...
    Left = 248
    Top = 272
    object qPlanoPagamentoID_TIPO_PAGAMENTO: TIntegerField
      FieldName = 'ID_TIPO_PAGAMENTO'
      Required = True
    end
  ...
  object cdsPlanoPagamento: TClientDataSet
    ...
    Left = 312
    Top = 272
    object cdsPlanoPagamentoID_TIPO_PAGAMENTO: TIntegerField
      FieldName = 'ID_TIPO_PAGAMENTO'
      Required = True
    end
