...
type
  TfrmFechamentoCaixa = class(TForm)
    ...
    qTrocaDESCRICAO_PAGAMENTO: TStringField;
    qTrocaSUM: TFMTBCDField;
    cdsTrocaDESCRICAO_PAGAMENTO: TStringField;
    cdsTrocaSUM: TFMTBCDField;
    qTrocas: TSQLQuery;
    dspTrocas: TDataSetProvider;
    cdsTrocas: TClientDataSet;
    dsTrocas: TDataSource;
    qTrocasID_PDV: TIntegerField;
    qTrocasNR_ORCAMENTO: TIntegerField;
    qTrocasID_LOJA: TIntegerField;
    qTrocasID_USUARIO: TIntegerField;
    qTrocasID_GRUPO: TIntegerField;
    qTrocasDT_ORCAMENTO: TDateField;
    qTrocasVL_ORCAMENTO: TFMTBCDField;
    qTrocasVL_DESCONTO: TFMTBCDField;
    qTrocasVL_LIQUIDO: TFMTBCDField;
    qTrocasSTATUS: TStringField;
    qTrocasTRANSF: TStringField;
    qTrocasNOME_CLIENTE: TStringField;
    qTrocasCPF_CLIENTE: TStringField;
    qTrocasID_VENDEDOR: TIntegerField;
    qTrocasCAIXA: TIntegerField;
    qTrocasNOME: TStringField;
    qTrocasLOGIN: TStringField;
    cdsTrocasID_PDV: TIntegerField;
    cdsTrocasNR_ORCAMENTO: TIntegerField;
    cdsTrocasID_LOJA: TIntegerField;
    cdsTrocasID_USUARIO: TIntegerField;
    cdsTrocasID_GRUPO: TIntegerField;
    cdsTrocasDT_ORCAMENTO: TDateField;
    cdsTrocasVL_ORCAMENTO: TFMTBCDField;
    cdsTrocasVL_DESCONTO: TFMTBCDField;
    cdsTrocasVL_LIQUIDO: TFMTBCDField;
    cdsTrocasSTATUS: TStringField;
    cdsTrocasTRANSF: TStringField;
    cdsTrocasNOME_CLIENTE: TStringField;
    cdsTrocasCPF_CLIENTE: TStringField;
    cdsTrocasID_VENDEDOR: TIntegerField;
    cdsTrocasCAIXA: TIntegerField;
    cdsTrocasNOME: TStringField;
    cdsTrocasLOGIN: TStringField;
...
var
  Arquivo : TextFile;
  iTotalEspecie, iVezes, iCount,iCount1,iCount2,iCount3,iCount4 ,TotalGeral,QtDev,QtLeva, QtPecas : Integer;
  ...
  Memo1.Clear;
    ...
    begin
      ...
      Memo1.Lines.Add('------------------------------------------------------------------------------------');
        ...
        cdsTrocas.Close;
        cdsTrocas.Params[0].AsInteger := StrToInt(frmpdv.L_CAIXA.Caption);
        cdsTrocas.Params[1].AsDate    := StrToDate(DateToStr(Date));
        cdsTrocas.Params[2].AsInteger    := frmPdv.recInformacoes.id_Usuario;
        cdsTrocas.Open;
      ...
      // Localizar Quan peccas trocadas
        ...
        cdsTroca.Close;
        cdsTroca.Params[0].AsDate    := StrToDate(DateToStr(Date));
        cdsTroca.Params[1].AsInteger := StrToInt(frmpdv.L_CAIXA.Caption);
        cdsTroca.Params[2].AsInteger    := frmPdv.recInformacoes.id_Usuario;
        cdsTroca.Open;
        cdsTroca.First;
        for iCount4:= 1 to cdsTroca.RecordCount do
        begin
          Memo1.Lines.Add(DefineTamanhoString(cdsTrocaDESCRICAO_PAGAMENTO.AsString,35,0)
                          +DefineTamanhoString('        ',15,15)
                          +DefineTamanhoString(FormatFloat('###,###,###0.00',cdsTrocaSUM.AsFloat),10,60));
          cdsTroca.Next;
        end;
        ...
        Memo1.Lines.Add('VALOR TOTAL DAS TROCAS EM R$............:  '+' '+FormatFloat('###,###0.00',TotalTroca));
        Memo1.Lines.Add('------------------------------------------------------------------------------------');
