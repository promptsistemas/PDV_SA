...
type
  TfrmReimpressaoOrcamento = class(TForm)
    ...
    BB_SAIR: TBitBtn;
    Memo2: TMemo;
    qOrcamentoHR_ORCAMENTO: TTimeField;
    qOrcamentoCUPOM: TStringField;
    cdsOrcamentoHR_ORCAMENTO: TTimeField;
...
procedure TfrmReimpressaoOrcamento.DBGrid1DrawColumnCell(Sender: TObject;
...
begin
  ...
  //            +' '+DefineTamanhoString(CDS_CUPON_PRODUTOcl_ds_unidade.AsString,4,0)
            ...
            dValor :=   cdsOrcamentoVL_ORCAMENTO.AsFloat; //dValor + cdsReimpressaoVL_TOTAL.AsFloat;
            dDesconto := cdsOrcamentoVL_DESCONTO.AsFloat;
            TotalGeral := cdsOrcamentoVL_LIQUIDO.AsFloat; //dValor;
            cdsReimpressao.Next;
          end
          else
          begin
  //          F_MENU_CLIENTE.Memo1.Lines.Add(#27#18+' ');
          ...
          Memo2.Lines.Add('VENDEDOR(A)  '+DefineTamanhoString(cdsOrcamentoNOME.AsString,20,0));
          Memo2.Lines.Add('');
          Memo2.Lines.Add('');
          ...
          DM.cdsDinamica.Close;
          DM.cdsDinamica.IndexFieldNames :='';
          DM.cdsDinamica.CommandText := ' SELECT SUM(IP.QUANT) FROM TB_ITEM_PDV IP WHERE IP.NR_ORCAMENTO = '+IntToStr(cdsOrcamentoNR_ORCAMENTO.AsInteger);
          DM.cdsDinamica.Open;
