...
begin
  ...
  begin
    ShowMessage('Desconto Não Permitido, Ultrapassa os 10% Permitido');

    if Application.MessageBox('Liberar Com Senha do Gerente?','Confirmação!',MB_YESNO+MB_ICONQUESTION) = idyes then
    begin
